  ...
  return (
    <div className='container'>
      <div className='section'>
        ...
        <p>
          Here we have my edited portfolio with projects that I have been
          working on. These projects display my abilities learned from Rutgers,
          DeVry and self-teachings, as well. I will continually refine the
          project over time to showcase my abilities.
        </p>
      </div>
    </div>
  );
